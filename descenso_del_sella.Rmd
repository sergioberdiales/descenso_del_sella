...
```{r }
summary(as.factor(vencedores$Municipio))
```
Arreglo esto creando una nueva variable 'País' donde sólo quede registrado el país
```{r }
vencedores_prueba <- vencedores %>% mutate(pais = ifelse(Año < 1951, "España", Municipio))
```
